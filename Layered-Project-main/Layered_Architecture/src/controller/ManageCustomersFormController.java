...
public class ManageCustomersFormController {
    ...
    private void loadAllCustomers() {
        ...
        try {
            ...
            ArrayList<CustomerDTO> allCustomers = customerDAO1.getAllCustomers();
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            ...
            try {
                ...
                CustomerBoImpl customerBo=new CustomerBoImpl();
                customerBo.addCustomer(new CustomerDTO());
            ...
            try {
                ...
                customerDAO1.updateCustomer(new CustomerDTO());
    ...
    boolean existCustomer(String id) throws SQLException, ClassNotFoundException {
        return customerDAO1.existCustomer(id);
    }
    ...
    private String generateNewId() {
        try {
           ...
           // CustomerDAOImpl customerDAO = new CustomerDAOImpl();
            return customerDAO1.generateNewCustomerID();
        } catch (SQLException e) {
